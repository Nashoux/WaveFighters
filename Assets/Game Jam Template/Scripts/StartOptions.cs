...
public class StartOptions : MonoBehaviour {
	...
	int sceneToStart;										//Index number in build settings of scene to load if changeScenes is true
...
//	[HideInInspector] public Animator animMenuAlpha;					//Reference to animator that will fade out alpha of MenuPanel canvas group
	public Animator animStageSelectionScreenAlpha;	//Reference to animator that will fade out alpha of StageSelectionScreen canvas group
...
//		animMenuAlpha.SetTrigger ("fade");
		animStageSelectionScreenAlpha.SetTrigger ("fade");
